...
const Profile = () => {
  ...
  const [currentDisplayUserLoading, setCurrentDisplayUserLoading] =
    useState(true);
    ...
    <div className="profile">
      ...
      <div className="profile__information">
        <div className="profile__fullname">
          {currentDisplayUser?.lastname + " " + currentDisplayUser?.firstname}
        </div>
